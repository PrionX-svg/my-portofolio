export const BaseInfo = {
  ...
  export const aboutInfo = {
    ...
    description:
      "At IndoTim warriors, we’re a dedicated team of designers and developers committed to delivering tailored web solutions. With a blend of creativity and technical expertise, we help businesses elevate their online presence and achieve their goals",
    client: "50+",
    experience: "3+",
    project: "200+",
    website: "100+",
  ...
  export const contactData = {
    phone: "+6281284762623",
    email: "olivia.salma@createit.co.id",
